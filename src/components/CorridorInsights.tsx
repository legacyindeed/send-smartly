  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-5">
        ...
        <h3 className="font-heading text-lg font-bold text-foreground">Popular Corridors</h3>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {corridors.map((c, i) => (
          <motion.div
            ...
            className="rounded-xl border border-border p-4 hover:shadow-card-hover transition-all"
          >
